...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="PUBG"/>
                        ...
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                ...
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    ...
                                    <input id="ttxs_pro_comment" marginLeft="4" marginRight="6" text="我们一定要全心全意为人民服务₍˄·͈༝·͈˄*₎◞ ̑̑|只有不忘初心，才能牢记使命(*´I`*)|领导不忘初心，结果方得始终(˵¯͒〰¯͒˵)|我们只有永远坚持党的领导，才能走上幸福之路⌓‿⌓|人民最终走向富强、民主、文明、和谐的道路ƪ(˘⌣˘)ʃ优雅|我们都会过上自由，平等，公正，法治的生活(●'◡'●)" textSize="13sp"  inputType="textMultiLine" />
                                </vertical>
                            </horizontal>
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
...
ui.start.click(function () {
    ...
    threads.start(function () {
        execution = engines.execScript("PUBG", getScript(ui.script_chosen.getSelectedItemPosition()));
    });
});
...
ui.ttxs_pro_reset.click(function () {
    ...
    TTXS_PRO_CONFIG.put("comment", "我们一定要全心全意为人民服务₍˄·͈༝·͈˄*₎◞ ̑̑|只有不忘初心，才能牢记使命(*´I`*)|领导不忘初心，结果方得始终(˵¯͒〰¯͒˵)|我们只有永远坚持党的领导，才能走上幸福之路⌓‿⌓|人民最终走向富强、民主、文明、和谐的道路ƪ(˘⌣˘)ʃ优雅|我们都会过上自由，平等，公正，法治的生活(●'◡'●)");
...
function Initialize() {
    ...
    ui.ttxs_pro_comment.setText(TTXS_PRO_CONFIG.get("comment", "我们一定要全心全意为人民服务₍˄·͈༝·͈˄*₎◞ ̑̑|只有不忘初心，才能牢记使命(*´I`*)|领导不忘初心，结果方得始终(˵¯͒〰¯͒˵)|我们只有永远坚持党的领导，才能走上幸福之路⌓‿⌓|人民最终走向富强、民主、文明、和谐的道路ƪ(˘⌣˘)ʃ优雅|我们都会过上自由，平等，公正，法治的生活(●'◡'●)"));
